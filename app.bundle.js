...
"use strict";
eval("\r\nvar __extends = (this && this.__extends) || (function () {\r\n    var extendStatics = function (d, b) {\r\n        extendStatics = Object.setPrototypeOf ||\r\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\r\n            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };\r\n        return extendStatics(d, b);\r\n    };\r\n    return function (d, b) {\r\n        extendStatics(d, b);\r\n        function __() { this.constructor = d; }\r\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\r\n    };\r\n})();\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nexports.GameScene = void 0;\r\nvar helpers_1 = __webpack_require__(/*! ../helpers */ \"./src/helpers.ts\");\r\nvar grid_target_1 = __webpack_require__(/*! ../classes/grid_target */ \"./src/classes/grid_target.ts\");\r\nvar sceneConfig = {\r\n    active: false,\r\n    visible: false,\r\n    key: 'Game',\r\n};\r\nvar Point = /** @class */ (function () {\r\n    function Point() {\r\n    }\r\n    return Point;\r\n}());\r\nvar GameScene = /** @class */ (function (_super) {\r\n    __extends(GameScene, _super);\r\n    function GameScene() {\r\n        var _this = _super.call(this, sceneConfig) || this;\r\n        _this.speed = 200;\r\n        _this.roundLength = 15;\r\n        _this.gridSize = 5;\r\n        _this.targetCount = 3;\r\n        _this.randomGenerator = Phaser.Math.RND;\r\n        return _this;\r\n    }\r\n    GameScene.prototype.create = function () {\r\n        //Make a 2d Array of bools set to true.\r\n        this.positions = this.make2dArray(this.gridSize);\r\n        for (var i = 0; i < this.positions.length; i++) {\r\n            for (var p = 0; p < this.positions.length; p++) {\r\n                this.positions[i][p] = true;\r\n            }\r\n        }\r\n        this.columnWidth = helpers_1.getGameWidth(this) / this.gridSize;\r\n        //Spawn the first x targets\r\n        for (var i = 0; i < this.targetCount; i++) {\r\n            this.spawnTarget();\r\n        }\r\n        //Set up hud\r\n        this.scoreText = this.add.text(16, 16, 'Score: 0', { fontSize: '24px' });\r\n        this.score = 0;\r\n        this.timeLeft = this.roundLength;\r\n        this.timeLeftText = this.add\r\n            .text(helpers_1.getGameWidth(this) - 16, 16, 'Time: ' + this.timeLeft, { fontSize: '24px' })\r\n            .setOrigin(1, 0);\r\n        this.timedEvent = this.time.addEvent({\r\n            delay: 1000,\r\n            callback: this.tickEvent,\r\n            callbackScope: this,\r\n            loop: true,\r\n        });\r\n        //audio\r\n        this.popSound = this.sound.add('pop');\r\n        //anim\r\n        this.anims.create({\r\n            key: 'puffPlay',\r\n            frames: this.anims.generateFrameNumbers('puff', { frames: [0, 1, 2, 3, 4, 5] }),\r\n            frameRate: 30,\r\n        });\r\n    };\r\n    // public update(): void {}\r\n    GameScene.prototype.hit = function (target) {\r\n        console.log('Spawning.');\r\n        target.setVisible(false);\r\n        this.spawnTarget();\r\n        this.score += 100;\r\n        this.scoreText.setText('Score: ' + this.score);\r\n        this.positions[target.gridX][target.gridY] = true;\r\n        target.destroy();\r\n        this.popSound.play();\r\n        var puffImage = this.add.sprite(target.x, target.y, 'puff');\r\n        puffImage.displayWidth = helpers_1.getGameWidth(this) / (this.gridSize - 2); //set this to array length\r\n        puffImage.scaleY = puffImage.scaleX;\r\n        puffImage.on(Phaser.Animations.Events.ANIMATION_COMPLETE, function () {\r\n            puffImage.destroy();\r\n        });\r\n        puffImage.setDepth(-1);\r\n        puffImage.setRotation(this.randomGenerator.rotation());\r\n        puffImage.play('puffPlay');\r\n    };\r\n    GameScene.prototype.placeAt = function (xx, yy, obj) {\r\n        //calculate the center of the cell\r\n        //by adding half of the height and width\r\n        //to the x and y of the coordinates\r\n        var x2 = this.columnWidth * xx + this.columnWidth / 2;\r\n        var y2 = this.columnWidth * yy + this.columnWidth / 2;\r\n        obj.x = x2;\r\n        obj.y = y2 + this.columnWidth;\r\n    };\r\n    GameScene.prototype.make2dArray = function (len) {\r\n        var a = [];\r\n        while (a.push([]) < len)\r\n            ;\r\n        return a;\r\n    };\r\n    //Recursive: Try randomly generating spawn coordinates and spawning target until an open position is found.\r\n    GameScene.prototype.spawnTarget = function () {\r\n        var _this = this;\r\n        var spawned = false;\r\n        var spawnPoint = this.getOpenPosition();\r\n        this.positions[spawnPoint.x][spawnPoint.y] = false;\r\n        var target = new grid_target_1.GridTarget(this, 0, 0, spawnPoint.x, spawnPoint.y);\r\n        this.placeAt(spawnPoint.x, spawnPoint.y, target);\r\n        target.displayWidth = helpers_1.getGameWidth(this) / (this.gridSize + 1); //set this to array length\r\n        target.scaleY = target.scaleX;\r\n        target.on('pointerdown', function () {\r\n            _this.hit(target);\r\n        });\r\n        spawned = true;\r\n    };\r\n    GameScene.prototype.getOpenPosition = function () {\r\n        var positionFound = false;\r\n        var point = new Point();\r\n        while (positionFound === false) {\r\n            var gridX = Phaser.Math.Between(0, this.positions.length - 1);\r\n            var gridY = Phaser.Math.Between(0, this.positions.length - 1);\r\n            if (this.positions[gridX][gridY] === true) {\r\n                point.x = gridX;\r\n                point.y = gridY;\r\n                positionFound = true;\r\n            }\r\n        }\r\n        return point;\r\n    };\r\n    GameScene.prototype.tickEvent = function () {\r\n        this.timeLeft -= 1;\r\n        this.timeLeftText.setText('Time: ' + this.timeLeft);\r\n        if (this.timeLeft < 6) {\r\n            this.timeLeftText.setColor('red');\r\n        }\r\n        if (this.timeLeft === 0) {\r\n            this.scene.start('MainMenu');\r\n        }\r\n    };\r\n    return GameScene;\r\n}(Phaser.Scene));\r\nexports.GameScene = GameScene;\r\n\n\n//# sourceURL=webpack:///./src/scenes/game-scene.ts?");
